...
// --- Customer-Specific Fields Component ---
...
const ExpertFields = ({ expertDetails, setExpertDetails }) => {
    ...
    const removeServiceArea = (pincodeToRemove) => {
        setExpertDetails(prev => ({
            ...prev,
            serviceAreas: (prev.serviceAreas || []).filter(area => area.pincode !== pincodeToRemove)
        }));
    };
            ...
            <div className='border border-orange-300 p-4 rounded-xl'>
                ...
                <div className="flex space-x-2 mb-3">
                    ...
                    <input
                        ...
                        onChange={(e) => setNewServicePincode(e.target.value.replace(/\D/g, ''))}
